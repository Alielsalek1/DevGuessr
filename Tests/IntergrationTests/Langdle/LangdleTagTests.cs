...
public class LangdleTagTests(CustomWebApplicationFactory factory) : BaseIntegrationTest(factory)
{
    ...
    public async Task AddTag_ToExistingLanguage_Returns200Ok()
    {
        ...
        var tagRequest = new AddLangdleTagByNameRequestDto { Tag = "NewTag" };
        var (response, content, _) = await LangdleTestHelpers.AddTagAsync<SuccessApiResponse<AddLangdleTagByNameResponseDto>>(client, name, tagRequest);
    ...
    public async Task AddTag_ToNonexistentLanguage_Returns404NotFound()
    {
        ...
        var tagRequest = new AddLangdleTagByNameRequestDto { Tag = "NewTag" };
        var (response, _, _) = await LangdleTestHelpers.AddTagAsync<FailApiResponse>(client, "NonExistentLang", tagRequest);
    ...
    public async Task RemoveTag_FromExistingLanguage_Returns200Ok()
    {
        ...
        var tagRequest = new RemoveLangdleTagByNameRequestDto { Tag = "TagToRemove" };
        var (response, content, _) = await LangdleTestHelpers.RemoveTagAsync<SuccessApiResponse<RemoveLangdleTagByNameResponseDto>>(client, name, tagRequest);
    ...
    public async Task RemoveTag_FromNonexistentLanguage_Returns404NotFound()
    {
        ...
        var tagRequest = new RemoveLangdleTagByNameRequestDto { Tag = "Whatever" };
        var (response, _, _) = await LangdleTestHelpers.RemoveTagAsync<FailApiResponse>(client, "NonExistentLang", tagRequest);
    ...
    public async Task AddTag_AlreadyExistingTag_Returns409Conflict()
    {
        ...
        var tagRequest = new AddLangdleTagByNameRequestDto { Tag = "ExistingTag" };
        var (response, content, _) = await LangdleTestHelpers.AddTagAsync<FailApiResponse>(client, name, tagRequest);
    ...
    public async Task RemoveTag_NonexistentTag_Returns404NotFound()
    {
        ...
        var tagRequest = new RemoveLangdleTagByNameRequestDto { Tag = "NonExistentTag" };
        var (response, content, _) = await LangdleTestHelpers.RemoveTagAsync<FailApiResponse>(client, name, tagRequest);
