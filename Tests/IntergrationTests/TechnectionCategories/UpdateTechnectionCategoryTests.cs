...
public class UpdateTechnectionCategoryTests(CustomWebApplicationFactory factory) : BaseIntegrationTest(factory)
{
    ...
    public async Task Update_WithValidData_Returns200OK()
    {
        ...
        var updateRequest = new UpdateTechnectionCategoryByGroupNameRequestDto
        {
            DifficultyLevel = 3,
            SuccessMessage = "Well done on group!"
        };

        var (response, content, json) = await TechnectionCategoriesTestHelpers.UpdateAsync<SuccessApiResponse<UpdateTechnectionCategoryByGroupNameResponseDto>>(
    ...
    public async Task Update_DoesNotModifyWords()
    {
        ...
        var updateRequest = new UpdateTechnectionCategoryByGroupNameRequestDto { SuccessMessage = "Changed message" };

        var (_, content, _) = await TechnectionCategoriesTestHelpers.UpdateAsync<SuccessApiResponse<UpdateTechnectionCategoryByGroupNameResponseDto>>(
    ...
    public async Task Update_WithDuplicateGroupName_Returns409Conflict()
    {
        ...
        var updateRequest = new UpdateTechnectionCategoryByGroupNameRequestDto { GroupName = "UpdConflict2" };
    ...
    public async Task Update_WithNonExistentCategory_Returns404NotFound()
    {
        ...
        var updateRequest = new UpdateTechnectionCategoryByGroupNameRequestDto { SuccessMessage = "Nope" };
    ...
    public async Task Update_WithInvalidDifficultyLevel_Returns400BadRequest()
    {
        ...
        var updateRequest = new UpdateTechnectionCategoryByGroupNameRequestDto { DifficultyLevel = 99 };
