...
public class CreateTechnectionCategoryRequestDtoValidator : AbstractValidator<CreateTechnectionCategoryRequestDto>
{
    public CreateTechnectionCategoryRequestDtoValidator()
    {
