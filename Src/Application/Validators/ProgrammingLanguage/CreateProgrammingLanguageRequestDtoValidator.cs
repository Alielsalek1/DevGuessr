...
public class CreateProgrammingLanguageRequestDtoValidator : AbstractValidator<CreateProgrammingLanguageRequestDto>
{
    public CreateProgrammingLanguageRequestDtoValidator()
    {
        RuleFor(x => x.Name)
